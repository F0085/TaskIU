                                                                            ...
                                                                            <tr>
                                                                                    ...
                                                                                    <td align="center">
                                                                                                    <div class="col-md-12">
                                                                                                        ...
                                                                                                        <button  type="button" class=" btn btn-info btn-sm" onclick="EditarAreaRol('{{$valor['Id_Roles']}}')">  <span class="ti-pencil-alt"></span></button>  <button  type="button" class=" btn btn-danger btn-sm" onclick="EliminarAreaRoles('{{$valor['Id_Roles']}}')">  <span class="icon-trash"></span></button></div>
                                                                                                    </div></td>
