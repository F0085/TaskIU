                                                            ...
                                                            <div class="table-responsive" style="overflow:scroll; height:230px; width:100%;">
                                                                <table class="table table-bordered table-sm " style="color: black" >
                                                                    ...
                                                                    <tbody id="table_SubArea">
                                                                        @if(isset($AreaSubArea))
                                                                            @foreach($AreaSubArea as $valor)
                                                                                <tr align="center">
                                                                                    <td >{{$valor['Area']}}</td>
                                                                                     <td >{{$valor['SubArea']}}</td>
                                                                           
                                                                                    <td><button  type="button" class=" btn btn-info btn-sm" onclick="EditarSubArea('{{$valor['Id_Sub_Area']}}')">  <span class="ti-pencil-alt"></span></button>  <button  type="button" class=" btn btn-danger btn-sm" onclick="EliminarSubArea('{{$valor['Id_Sub_Area']}}')">  <span class="icon-trash"></span></button>
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                                                                        @endif
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <select disabled="true" name="SubArea_A_ROL" id="SubArea_A_ROL" class="form-control input-default">
                                                                        ...
                                                                        @foreach($SubArea as $v)
                                                                            <option value="{{$v['Id_Sub_Area']}}">{{$v['Descripcion']}}</option>
                                                                        @endforeach                                               
                                                                    </select>
                                                                </div>
                                                            </div>
