                            ...
                            <div class="drop-down animated fadeIn dropdown-menu">
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="<?php echo e(asset('images/avatar/2.jpg')); ?>" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="<?php echo e(asset('images/avatar/3.jpg')); ?>" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="<?php echo e(asset('images/avatar/4.jpg')); ?>" alt="">
                                                <div class="notification-content">
