                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo e(route('rolesUser')); ?>">
                             ...
                             <?php if(isset($Usuarios)): ?>
                                <select name="" id="" class="form-control input-default">
                                	...
                                	<option value=""><?php echo e($v['descripcion']); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TaskManta\resources\views/GestionUsuarios/RegistroUsuarios.blade.php ENDPATH**/ ?>