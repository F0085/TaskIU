    		...
    		<div class="col-md-8">
	    		...
	    		<div class="alert alert-success" role="alert" >
	    			<?php if(isset($Id_Reunion) && isset($Id_Usuario) ): ?>
				  	...
				  	<hr>
				  	<form  enctype="multipart/form-data" class="form-horizontal  " method="POST" action="<?php echo e(url('Motivo/'.$Id_Reunion.'/'.$Id_Usuario)); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\TaskManta\resources\views/ConfirmarAsistencia/NoAsiste.blade.php ENDPATH**/ ?>